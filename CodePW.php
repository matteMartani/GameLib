    ...
    <body class="fontoriginale bg-dark sfondo">
        ...
        <nav class="main-breadcrumb" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="collegamento-scuro" href="Login.html">Login</a></li>
                <li class="breadcrumb-item"><a class="collegamento-scuro" href="ForgotPW.html">Did you forget your password?</a></li>
                <li class="breadcrumb-item text-white" aria-current="page">Passcode</li>
            </ol>
        </nav>
        ...
        <section class="py-5 text-center container fontoriginale bg-light main-section">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light text-muted font-scritte">VERIFY</h1>
                    <p>
                    <form>
                        ...
                        <br>
                        <div class="form-group">
                            <button type="submit" class="btn btn-success">Confirm <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-circle" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"/>
                                </svg></button>

                            <a role="button" class="btn btn-secondary" href="ForgotPW.html">Change email instead <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
