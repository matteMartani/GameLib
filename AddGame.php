    ...
    <body class="fontoriginale bg-dark sfondo">
        ...
        <nav class="main-breadcrumb" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-white" aria-current="page">Add a Game</li>
            </ol>
        </nav>
        
        <div class="py-5 text-center container fontoriginale bg-light main-section">
            <div class="row">
                <div class="col-lg-6">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            <h1 class="fw-light text-secondary font-scritte">ADD A VIDEOGAME YOU PLAYED</h1>
                            <p>
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Playtime">
                                </div>
                                ...
                                <br>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success">Add <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-node-plus-fill" viewBox="0 0 16 16">
                                        <path d="M11 13a5 5 0 1 0-4.975-5.5H4A1.5 1.5 0 0 0 2.5 6h-1A1.5 1.5 0 0 0 0 7.5v1A1.5 1.5 0 0 0 1.5 10h1A1.5 1.5 0 0 0 4 8.5h2.025A5 5 0 0 0 11 13zm.5-7.5v2h2a.5.5 0 0 1 0 1h-2v2a.5.5 0 0 1-1 0v-2h-2a.5.5 0 0 1 0-1h2v-2a.5.5 0 0 1 1 0z"/>
                                        </svg></button>

                                    <a role="button" class="btn btn-danger" href="YourGames.php">Cancel <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
                ...
                <div class="col-lg-6">
                    ...
                    <figure class="figure main-figura">
                        <img src="img/Placeholder1.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
                    </figure>
