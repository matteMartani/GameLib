...
<html>
    <head>
        <title>Stats about a game</title>
        <meta charset="UTF-8">
    ...
    <body class="fontoriginale bg-dark">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-attivo" href="allGames.html">All Games</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <h1 class="font-scritte text-light">$Game Statistics </h1>
                    ...
                    <table class="table table-striped table-hover table-responsive table-dark" style="width:100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Playtime (hours)</th>
