...
@section('breadcrumb')
    <nav class="main-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="text-dark" href="{{route('software_house.index')}}">{{trans('labels.sh')}}</a></li>
            <li class="breadcrumb-item text-dark" aria-current="page">{{trans('labels.delete')}} {{$nome}}</li>
        </ol>
    </nav>
@endsection
   ...
   <section class="py-5 text-center container-fluid fontoriginale sfondo">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light text-white font-scritte">{{trans('labels.delete2')}} {{$nome}} {{trans('labels.from')}}</h1>
            <p>
                <a href="{{route('software_house.index')}}" class="btn btn-outline-light btn-lg my-2">{{trans('labels.revert')}} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-90deg-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1.146 4.854a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H12.5A2.5 2.5 0 0 1 15 6.5v8a.5.5 0 0 1-1 0v-8A1.5 1.5 0 0 0 12.5 5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4z"/>
                    </svg></a>
                <a href="{{ route('software_house.eliminate', $software_house_id) }}" class="btn btn-outline-danger btn-lg my-2">{{trans('labels.delete')}} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
